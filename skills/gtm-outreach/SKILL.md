...
- `contact_id`: UUID
- `experiment_id`: UUID
- Outreach framework: `research/outreach-framework.md` in your OpenClaw workspace (create this file with your tone/angle guidelines)
...
Read `research/outreach-framework.md` in your OpenClaw workspace in full. This defines tone, structure, length constraints, and angle guidelines. Follow it strictly.
...
```
You are drafting a cold outreach sequence for {YOUR_COMPANY_NAME} ({YOUR_PRODUCT_URL}).
...
5 must have run (company needs research + signals)
