...
Read the skill at `skills/sales-deck/SKILL.md in your OpenClaw workspace` and follow its instructions to generate the deck.
...
- Sales-deck skill at `skills/sales-deck/SKILL.md in your OpenClaw workspace`
